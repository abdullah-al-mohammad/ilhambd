...
export default function CategoryPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const { data, loading, error } = useFetch<ApiProduct[]>(`/api/products?category=${slug}`);
      ...
      <div className="container mx-auto px-4">
          ...
          <div>
            <div className="text-sm breadcrumbs mb-2">
              <ul>
                ...
                <li>Category</li>
                <li className="text-primary font-bold">{formattedCategoryName}</li>
              </ul>
            </div>
            <h1 className="text-3xl font-bold">{formattedCategoryName} Products</h1>
          </div>
        ...
        {!loading && error && (
          <div className="alert alert-error">
            ...
            <span>Failed to load products for this category. Please try again.</span>
          </div>
        )}
        ...
        {!loading && !error && productsToRender.length === 0 && (
          <div className="text-center py-20 bg-base-100 rounded-2xl shadow-sm border border-base-200">
            ...
            <p className="text-base-content/60 mb-6">We couldn't find any products in the "{formattedCategoryName}" category.</p>
              ...
              <div key={product.id} className="card bg-base-100 shadow-sm border border-base-200 hover:shadow-md transition-shadow">
                <div className="card-body p-4 relative group flex flex-col h-full">
                  ...
                  <div className="flex flex-col flex-grow">
                    <h6 className="font-bold text-base line-clamp-2 mb-2 leading-tight flex-grow">{product.name}</h6>
