...
export default function LoginPage() {
  ...
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-base-200">Loading...</div>}>
      <div className="min-h-screen flex items-center justify-center bg-base-200 px-4 py-12">
        ...
        >
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            {success && (
              <div className="alert alert-success shadow-lg py-2 text-sm">
                <span>{success}</span>
              </div>
            )}
            ...
            <div className="space-y-4">
              ...
              <div className="form-control">
                <label className="label">
                  ...
                  <Link href="#" className="label-text-alt link link-primary no-underline hover:underline">
                    Forgot password?
                  </Link>
                </label>
          ...
          <div className="text-center">
            <p className="text-sm text-base-content/60">
              ...
              <Link href={`/register${redirectPath !== '/' ? `?redirect=${redirectPath}` : ''}`} className="font-medium link link-primary no-underline hover:underline">
                Sign up for free
              </Link>
            </p>
          </div>
